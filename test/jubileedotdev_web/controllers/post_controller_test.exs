defmodule JubileedotdevWeb.PostControllerTest do
  use JubileedotdevWeb.ConnCase

  alias Jubileedotdev.Blog

  @create_attrs %{content: "some content", created: "2010-04-17T14:00:00Z", id: 42, title: "some title", updated: "2010-04-17T14:00:00Z"}
