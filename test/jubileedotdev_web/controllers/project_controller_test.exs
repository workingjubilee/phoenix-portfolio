defmodule JubileedotdevWeb.ProjectControllerTest do
  use JubileedotdevWeb.ConnCase

  alias Jubileedotdev.Portfolio

  @create_attrs %{image: "some image", notes: "some notes", title: "some title", uri: "some uri"}
  ...
  def fixture(:project) do
    {:ok, project} = Portfolio.create_project(@create_attrs)
    project
  end
